...
In this tutorial, we'll create a Kubernetes v1.12.0 cluster on Google Compute Engine with Fedora Atomic.
...
module "google-cloud-yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/fedora-atomic/kubernetes?ref=v1.12.0"
