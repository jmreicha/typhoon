...
In this tutorial, we'll create a Kubernetes v1.12.0 cluster on AWS with Fedora Atomic.
...
```tf
module "aws-tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/fedora-atomic/kubernetes?ref=v1.12.0"
