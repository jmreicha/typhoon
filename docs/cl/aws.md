...
In this tutorial, we'll create a Kubernetes v1.12.0 cluster on AWS with Container Linux.
...
```tf
module "aws-tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/container-linux/kubernetes?ref=v1.12.0"
...
ip-10-0-12-221   Ready     34m       v1.12.0
ip-10-0-19-112   Ready     34m       v1.12.0
ip-10-0-4-22     Ready     34m       v1.12.0
```
