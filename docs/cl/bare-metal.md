...
In this tutorial, we'll network boot and provision a Kubernetes v1.12.0 cluster on bare-metal with Container Linux.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/container-linux/kubernetes?ref=v1.12.0"
