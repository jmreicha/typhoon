...
In this tutorial, we'll create a Kubernetes v1.12.0 cluster on DigitalOcean with Container Linux.
...
module "digital-ocean-nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/container-linux/kubernetes?ref=v1.12.0"
...
10.132.110.130   Ready     10m       v1.12.0
10.132.115.81    Ready     10m       v1.12.0
10.132.124.107   Ready     10m       v1.12.0
```
