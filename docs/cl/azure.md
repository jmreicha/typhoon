...
In this tutorial, we'll create a Kubernetes v1.12.0 cluster on Azure with Container Linux.
...
```tf
module "azure-ramius" {
  source = "git::https://github.com/poseidon/typhoon//azure/container-linux/kubernetes?ref=v1.12.0"
...
ramius-controller-0   Ready   controller,master  24m  v1.12.0
ramius-worker-000001  Ready   node               25m  v1.12.0
ramius-worker-000002  Ready   node               24m  v1.12.0
ramius-worker-000005  Ready   node               24m  v1.12.0
```
