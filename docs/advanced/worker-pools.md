...
module "tempest-worker-pool" {
  source = "git::https://github.com/poseidon/typhoon//aws/container-linux/kubernetes/workers?ref=v1.12.0"
...
module "ramius-worker-pool" {
  source = "git::https://github.com/poseidon/typhoon//azure/container-linux/kubernetes/workers?ref=v1.12.0"
...
module "yavin-worker-pool" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/container-linux/kubernetes/workers?ref=v1.12.0"
...
yavin-controller-0.c.example-com.internal        Ready    6m     v1.12.0
yavin-worker-jrbf.c.example-com.internal         Ready    5m     v1.12.0
yavin-worker-mzdm.c.example-com.internal         Ready    5m     v1.12.0
yavin-16x-worker-jrbf.c.example-com.internal     Ready    3m     v1.12.0
yavin-16x-worker-mzdm.c.example-com.internal     Ready    3m     v1.12.0
```
